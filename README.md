...
Note that the API updates every second to ensure currentness of data, allowing us to assess the impact of election events as they happen (such as the launch of big campaign ads, or the unfolding of scandals involving presidential candidates). 
